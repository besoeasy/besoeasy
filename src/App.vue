					...
					<div class="md:max-w-lg">
						...
						>
							<span
								...
								have collaborated with 70+ organizations, delivering mission-critical
								applications handling substantial financial and sensitive data.</span
							>
						</p>
						<p class="font-semibold tracking-tight text-2xl" contenteditable="false">
							Aman Singh Katal
						</p>
						...
						<div class="space-y-3 space-y-4 leading-6 text-left xl:space-y-5 uppercase mt-8">
